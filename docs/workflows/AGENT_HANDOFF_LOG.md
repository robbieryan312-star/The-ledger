...
**Current state:** `cursor/m-retire-votesmart-channel-proof-70a6` · tip = **`2336b13`** · B/C/D on `main` · `rm -rf .next && npm run prebuild` **0** · `npm run build` **0**
...
**M-RETIRE-VOTESMART + M-CHANNEL-PROOF tip:** approve exact **`2336b13`** · prebuild 0 · build 0  
