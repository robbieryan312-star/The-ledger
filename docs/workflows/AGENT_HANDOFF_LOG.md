...
**Current state:** `cursor/m-retire-votesmart-channel-proof-70a6` · tip = **`f966a0b`** · B/C/D on `main` · `rm -rf .next && npm run prebuild` **0** · `npm run build` **0**
...
**M-RETIRE-VOTESMART + M-CHANNEL-PROOF tip:** approve exact **`f966a0b`** · prebuild 0 · build 0  
