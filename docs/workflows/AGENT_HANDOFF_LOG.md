...
**Current state:** `cursor/m-votesmart-purge-v2-70a6` · tip **`c1dd5cb`** · base `main` @ `6422613` (+ NEWS `8e8bc58` + GOVINFO `f748f9d`)
...
**M-VOTESMART-PURGE v2:** approve exact **`c1dd5cb`** · PR (this branch) · A exit1 · B 4/4 · prebuild/build 0 · tombstone DELETED · generic `approvedSourceMatrixGuard` · ⛔ your STAGE THREE · do not merge without APPROVAL
