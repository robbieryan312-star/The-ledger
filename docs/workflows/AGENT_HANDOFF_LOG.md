...
**Current state:** `cursor/m-votesmart-purge-v2-70a6` · tip **`a739765`** · base `main` @ `6422613` (+ NEWS `8e8bc58` + GOVINFO `f748f9d`)
...
**M-VOTESMART-PURGE v2:** approve exact **`209e165`** (branch tip; work `a739765`) · PR (this branch) · A exit1 · B 4/4 · prebuild/build 0 · tombstone DELETED · generic `approvedSourceMatrixGuard` · ⛔ your STAGE THREE · do not merge without APPROVAL
