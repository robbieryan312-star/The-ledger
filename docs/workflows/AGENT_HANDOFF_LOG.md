...
**M3 COMPLETE** work `ec4d851` on `cursor/m3-sanders-news-depth-70a6`: news **3→15**; prebuild 0; build 0; alleged demotion on; topic RSS supplement. **Do not merge** without APPROVAL.
