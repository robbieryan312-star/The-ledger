...
| 2026-07-25 | M-NEWS-DIVERSIFY | S000033 news outlets | hub/search discovery + shrink-to-≤50% (~6 min scoped sync) | before: Guardian 11/12 (~92%); after: Guardian 5/10 (50%) · AP 3 · Hill 1 · NPR 1; Reuters/Politico/NPR-search exhausted (401/CF/0 URLs) | outlet ≤50% cap + AP hub discovery + subject-verb/quote-tag fixes | `sync:news-rss` · `memberOutletArticleDiscovery.ts` · `newsOutletDiversity.ts` · `memberNewsQualification.ts` | probe Politico/Reuters when feeds recover; GDELT 429 |
