...
**Generated:** 2026-07-19T22:51:25Z · **Baseline:** data/reports/file-inventory.json (258 files)
...
| lib/data/crecDisplayText.ts | Data accessor / transform | lib/data/issuesFromTopicPositions.ts, lib/data/profileSnapshot.ts, scripts/archive/apply-crec-sync-to-profiles.ts, scripts/archive/stamp-profile-display-text.ts, scripts/lib/profileMigrate.ts | — | KEEP | importer scan |
| lib/data/derivePromiseStatus.ts | Data accessor / transform | scripts/archive/report-pilot-coverage.ts | — | KEEP | importer scan |
...
| lib/data/fecScheduleA.ts | Data accessor / transform | app/politicians/[id]/page.tsx, components/finance/FollowTheMoneyPanel.tsx, components/politicians/PoliticianProfileClient.tsx, lib/data/buildOrgVoteTopicLinks.ts, scripts/archive/migrate-gold-profiles-batch1.ts | — | KEEP | importer scan |
...
| lib/data/issuesFromTopicPositions.ts | Data accessor / transform | app/politicians/[id]/page.tsx, lib/data/profileSnapshot.ts, scripts/archive/report-pilot-coverage.ts | — | KEEP | importer scan |
...
| lib/data/nationalCongressVotes.ts | Data accessor / transform | scripts/__tests__/sourceIntegrity.test.ts, scripts/archive/apply-crec-sync-to-profiles.ts, scripts/archive/migrate-gold-profiles-batch1.ts, scripts/lib/profileMigrate.ts, scripts/refresh-migrated-profile-votes.ts | — | KEEP | importer scan |
...
| lib/data/sanitizeProfileUiData.ts | Data accessor / transform | scripts/archive/apply-crec-sync-to-profiles.ts, scripts/archive/fetch-batch1-news.ts, scripts/archive/migrate-gold-profiles-batch1.ts, scripts/lib/profileMigrate.ts | — | KEEP | importer scan |
...
| lib/data/senateVotesClient.ts | Data accessor / transform | scripts/archive/refresh-senate-cast-votes.ts, scripts/ingest/florida/ingest-congress-florida.ts, scripts/sync-congress-votes.ts, scripts/sync-votes-national.ts | — | KEEP | importer scan |
...
| lib/data/sourceCatalog.ts | Data accessor / transform | scan: 0 importers (verify) | — | MERGE | override |
...
| lib/data/topicAliases.ts | Data accessor / transform | lib/data/issuesFromTopicPositions.ts, lib/data/memberDeep.ts, lib/data/profileRecordByTopic.ts, lib/data/sourceIntegrity.ts, scripts/archive/apply-crec-sync-to-profiles.ts | — | KEEP | importer scan |
| lib/data/topicCoverage.ts | Data accessor / transform | lib/data/issuesFromTopicPositions.ts, scripts/archive/report-pilot-coverage.ts, scripts/lib/articleVerificationCache.ts | — | KEEP | importer scan |
| lib/data/topicPositions.ts | Data accessor / transform | app/politicians/[id]/page.tsx, components/politicians/PoliticianProfileClient.tsx, components/politicians/ProfileRecordByTopicPanel.tsx, lib/data/buildSaidDidDiffs.ts, lib/data/issuesFromTopicPositions.ts | — | KEEP | importer scan |
...
| scripts/archive/apply-crec-sync-to-profiles.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/audit-overreject.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/benchmark-ingest-sample.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/compare-topic-batch.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/fetch-batch1-news.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/generate-roster.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
...
| scripts/archive/refresh-senate-cast-votes.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/report-pilot-coverage.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/stamp-profile-display-text.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/sync-profile-news.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/test-cosponsor-pipeline.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
| scripts/archive/verify-phase17b-batch.ts | Archived one-off script | archived — no npm script | — | KEEP | importer scan |
...
| scripts/lib/approvedMediaQuotes.ts | Pipeline shared library | scripts/archive/report-pilot-coverage.ts, scripts/sync-topic-positions.ts | — | KEEP | importer scan |
| scripts/lib/articleVerificationCache.ts | Pipeline shared library | scripts/archive/report-pilot-coverage.ts, scripts/lib/approvedMediaQuotes.ts | — | KEEP | importer scan |
...
| scripts/lib/crecOpener.ts | Pipeline shared library | scripts/__tests__/crecProceduralFilter.test.ts, scripts/archive/audit-overreject.ts, scripts/sync-topic-positions.ts | — | KEEP | importer scan |
| scripts/lib/crecProceduralFilter.ts | Pipeline shared library | scripts/__tests__/crecProceduralFilter.test.ts, scripts/archive/apply-crec-sync-to-profiles.ts, scripts/archive/audit-overreject.ts, scripts/audit-profile-credibility.ts, scripts/lib/profileMigrate.ts | — | KEEP | importer scan |
...
| scripts/refresh-migrated-profile-votes.ts | Source module | package.json: refresh:migrated-votes | — | KEEP | importer scan |
