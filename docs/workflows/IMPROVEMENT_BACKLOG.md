...
| IMP-PROFILE-SNAPSHOT-7 | Extend golden profile snapshots beyond S000033/M000355 to all 7 migrated profiles so migrated-profile-only statement regressions (e.g. M001184 procedural CREC rows) are render-guarded | P1 | cursor | open | `scripts/__tests__/profileSnapshots.test.ts` · `lib/data/__fixtures__/profileSnapshots/` |
