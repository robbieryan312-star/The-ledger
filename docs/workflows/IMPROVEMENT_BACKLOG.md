...
| BUG-ISSUE-EVIDENCE-PROVENANCE | Key Issues evidence must preserve recorded media outlet names instead of emitting generic `Journalism` | P0 | cursor | **done** | `lib/data/issuesFromTopicPositions.ts` · `provenanceOutletGuard.test.ts` |
