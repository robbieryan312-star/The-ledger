...
| 11 | County map drilldown | Ballotpedia + county `.gov` / SOE | Map explorer | **reference-2** (Miami-Dade `12086`, Liberty `12077`) | **partial** — Option A; ⛔ STOP before 67 (`docs/workflows/M8_COUNTY_MAP_DECISION.md`) |
