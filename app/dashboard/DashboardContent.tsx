...
export default function DashboardContent({
  ...
  const stateReps = useMemo(
    () => (hasLocation
      ? politiciansForStateRoster(politicians, profile.stateCode, rosterFilters.inOfficeOnly)
      : []),
    [hasLocation, profile.stateCode, rosterFilters.inOfficeOnly, politicians],
  );
  ...
  const trackedPoliticians = politicians.filter((p) => isTracked(p.id));
                  ...
                  <Link href={`/politicians/${p.id}`} className="block">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <div className="text-gray-400 text-xs">{p.party} · {p.resolvedOffice.label}</div>
                      </div>
                    </div>
                    ...
                    <Link key={p.id} href={`/politicians/${p.id}`}
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-gray-400 text-xs truncate">{p.party} · {p.resolvedOffice.label}</div>
                        </div>
