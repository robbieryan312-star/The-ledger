...
export default function CongressContent({
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <DataSourceStrip officialCount={officialTradeCount} demoCount={demoTradeCount} stockMeta={stockMeta} />
      <MethodologyPanel />
