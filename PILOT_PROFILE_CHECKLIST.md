...
| 8 | Said→Did pairing | topicPositions + `buildSaidDidDiffsFromTopicPositions` | Track Record · Said→Did panel | build-time | **partial** — **10**/15 CREC pairs with inline saidQuote+saidUrl; remainder honest-gap (explicit note in saidDid.json; no fabrication)|
