...
| 8 | Said→Did pairing | topicPositions + `buildSaidDidDiffsFromTopicPositions` | Track Record · Said→Did panel | build-time | **partial** — **14**/15 CREC pairs with inline saidQuote+saidUrl; Marvit nomination Said unpaired (no matching Did in corpus after nominee-overlap guard 2026-07-26)|
