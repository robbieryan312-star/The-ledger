...
| 8 | Said→Did pairing | topicPositions + `buildSaidDidDiffsFromTopicPositions` | Track Record · Said→Did panel | build-time | **partial** — **2**/15 official CREC Said→Did pairs (1 Said→1 Did; URL-stem dedup); remainder honest-gap (no force to 15)|
