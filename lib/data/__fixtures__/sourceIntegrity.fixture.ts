...
/** P000197 Phase E — date-led letter-sending narration (not a stated position). */
export const PLATFORM_KNOWN_BAD_LETTER_EVENT =
  "On September 5, 2013, Pelosi sent a third letter to House Democrats highlighting the restrictions of the Senate's use-of-force resolution.";

/** P000197 Phase E — inquiry-announcement narration (not a stated position). */
export const PLATFORM_KNOWN_BAD_INQUIRY_ANNOUNCEMENT =
  'House Speaker Nancy Pelosi (D-Calif.) first announced the House would pursue an inquiry into Trump on September 24, 2019, following allegations that Trump requested the Ukrainian government investigate former Vice President Joe Biden (D).';
