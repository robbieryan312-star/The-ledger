...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  },
  {
    ...
    outputPath: 'lib/data/generated/topicPositions.json (planned)',
    syncCommand: 'extend sync:topic-positions',
    agentPriority: 2,
    notes: 'Replaces VoteSmart NPAT for official Said. Key already in .env.local. Wire per bioguide search next.',
  },
  {
  ...
  },
  {
    ...
    outputPath: 'mockPoliticians / future curated JSON',
    agentPriority: 1,
...
export const PILOT_PROFILE_CHECKLIST: Array<{
  ...
  { dataNeed: 'Schedule A donors', sourceId: 'fec-schedule-a', destinationView: 'Follow the Money', pilotStatus: 'partial' },
  { dataNeed: 'Platform positions (Said)', sourceId: 'ballotpedia', destinationView: 'Track Record', pilotStatus: 'done' },
  { dataNeed: 'CREC floor speech (Said)', sourceId: 'govinfo-crec', destinationView: 'Track Record', pilotStatus: 'next' },
  ...
  { dataNeed: 'Org/PAC receipts by topic (Phase 17)', sourceId: 'fec-schedule-a', destinationView: 'Topic Record + votes', pilotStatus: 'next' },
];
