...
export const DATA_NEED_ROUTING: Array<{
  ...
  { need: 'Stated positions (Said) — survey/platform', destinationView: 'Track Record · Topic Record', primarySourceId: 'official-issues-pages', fallbackSourceIds: ['ballotpedia', 'govinfo-crec'] },
  ...
  { need: 'Member news', destinationView: 'News section', primarySourceId: 'news-rss-registry', fallbackSourceIds: ['gdelt-national', 'newsapi-fl'] },
...
export const SOURCE_CATALOG: SourceCatalogEntry[] = [
  ...
  },
  {
    ...
    outputPath: 'lib/data/generated/congressVotes.json · data/national/votes/congress-votes.json',
  ...
  },
  {
    ...
    outputPath: 'lib/data/generated/fecFinance.json · data/national/fec/congress-finance.json',
  ...
  },
  {
    ...
    outputPath: 'data/national/fec/schedule-a.json',
  ...
  {
    id: 'official-issues-pages',
    name: 'Official member /issues/ pages (senate.gov / house.gov)',
    url: 'https://www.sanders.senate.gov/issues/',
    sourceTier: 'official',
    category: 'positions',
    status: 'integrated',
    keyRequired: false,
    lookFor: ['Issues accordion / issue section verbatim stance text', 'page URL', 'asOf acquisition date'],
    ...
    syncCommand: 'npm run sync:official-issues-positions -- --member S000033',
    agentPriority: 1,
    notes:
      'PRIMARY platform-stance route. Proven 2026-07-25 on S000033 (Elementor accordion → 11 qualified). Campaign sites only if /issues/ qualifies (berniesanders.com redirects — does not).',
  },
  {
    id: 'ballotpedia',
    name: 'Ballotpedia',
    ...
    agentPriority: 2,
    notes:
      'SECONDARY after official /issues/. Control filled on M000355; S000033 Ballotpedia page poverty. Not verbatim quotes unless in quotation marks on page — label accordingly.',
  },
  {
  ...
  {
    id: 'news-rss-registry',
    name: 'Approved-outlet RSS registry',
    url: 'https://github.com/robbieryan312-star/The-ledger/blob/main/lib/data/newsFeedRegistry.ts',
    sourceTier: 'media',
    category: 'journalism',
    status: 'integrated',
    keyRequired: false,
    lookFor: ['headline', 'outlet from registry', 'article URL + date', 'member name in title/summary'],
  ...
  },
  {
    ...
    agentPriority: 2,
    notes: 'SECONDARY fallback when RSS registry is thin. Also invoked from sync:news-rss. Corroborate before using as Said.',
  },
  {
    id: 'approved-media',
  ...
  },
  {
    ...
    outputPath: 'data/florida/voteview/ · lib/data/slices/voteview',
  ...
  },
  {
    ...
    outputPath: 'data/florida/govtrack/',
  ...
  },
  {
    ...
    outputPath: 'data/florida/lobbying/',
  ...
  // ── Florida pipeline (integrated) — same credibility rules ─────────────────
  {
    ...
    outputPath: 'data/florida/legiscan/florida-*.json',
  ...
  },
  {
    ...
    outputPath: 'data/florida/openstates/',
  ...
  // ── Reference bulk (no key) ────────────────────────────────────────────────
  {
    ...
    outputPath: 'data/florida/spending/',
  ...
  },
  {
    ...
    outputPath: 'data/florida/census/',
  ...
  },
  {
    ...
    outputPath: 'data/florida/fllobbyist/',
...
export const PILOT_PROFILE_CHECKLIST: Array<{
  ...
  { dataNeed: 'Platform positions (Said)', sourceId: 'official-issues-pages', destinationView: 'Track Record', pilotStatus: 'done' },
